...
class IndexController extends BaseController
{
    ...
    public function index()
    {
        ...
        $meta = $metamodel->where('nama_halaman', 'Home')->first();
    ...
    {
        $metamodel = new MetaModel();
        $meta = $metamodel->where('nama_halaman', 'Services')->first();
    ...
    {
        $metamodel = new MetaModel();
        $meta = $metamodel->where('nama_halaman', 'Blogs')->first();
    ...
    {
        $metamodel = new MetaModel();
        $meta = $metamodel->where('nama_halaman', 'Contact Us')->first();
